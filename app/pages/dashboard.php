...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link href="../../assets/css/bootstrap-v5.0.2.css" rel="stylesheet"></head>
...
<div class="content active-cont">
    <div class="upperContainer">
        ...
        <div class="secondContainer">
            ...
            <div class="profile">
                <img src="../../assets/img/avatar.png" alt="profile img" class="profileImg">
            </div>
        </div>  
    </div>    
...
<!-- Bootstrap JS -->
<script src="../../assets/js/bootstrap-v5.0.2.js"></script>

<!-- ChartJs -->
<script src="../../assets/js/chartJs-v3.9.1.js"></script>
